...
# Save as ICO with multiple sizes in launchers folder
from pathlib import Path
output_dir = Path(__file__).parent.parent / 'launchers'
output_dir.mkdir(exist_ok=True)
output_path = output_dir / 'DriveOS.ico'
img.save(str(output_path), format='ICO', sizes=[(256, 256), (128, 128), (64, 64), (48, 48), (32, 32), (16, 16)])
